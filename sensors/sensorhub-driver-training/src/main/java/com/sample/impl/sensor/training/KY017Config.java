...
/**
 * Configuration settings for the {@link KY017Sensor} driver exposed via the OpenSensorHub Admin panel.
 * <p>
 ...
 * @since date
 */
public class KY017Config extends SensorConfig {
    ...
    public String serialNumber = "ky017";

    @DisplayInfo.Required
    @DisplayInfo(desc = "GPIO BCM Pin Number")
    public int bcmPinNumber = 23;
}
